...
# Provide dummy executables so CMake can configure without a real Qt SDK
set(QT_MOC_EXECUTABLE "${CMAKE_COMMAND}")
set(QT_RCC_EXECUTABLE "${CMAKE_COMMAND}")
set(QT_UIC_EXECUTABLE "${CMAKE_COMMAND}")
...
if(NOT TARGET Qt6::rcc)
    ...
    set_target_properties(Qt6::rcc PROPERTIES IMPORTED_LOCATION "${CMAKE_COMMAND}")
endif()
if(NOT TARGET Qt6::uic)
    add_executable(Qt6::uic IMPORTED)
    set_target_properties(Qt6::uic PROPERTIES IMPORTED_LOCATION "${CMAKE_COMMAND}")
endif()
